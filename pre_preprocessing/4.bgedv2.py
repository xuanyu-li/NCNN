...
def main():
    ...
    bgedv2_genes = list(information_data.data_df.index)
    bgedv2_samples =  list(information_data.data_df.columns)
    ...
    for i in range(len(lm_id)):
        ...
        probs_data = information_data.data_df.values[np.ix_(probs_idx, samples_idx)].astype('float64')
